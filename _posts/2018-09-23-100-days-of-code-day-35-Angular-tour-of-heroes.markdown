---
layout: post
title:  "100 Days of Code Day 35 - Angular tour of heroes pt3 and pt4"
date:   2018-09-23 08:33:00
categories: 100DaysOfCode
---

# Angular - Tour of heroes pt3

Ripping the heroes list view & the detail views apart, and giving the list view control over the detail view, by binding a specific hero, the selected one, to the input of the detail view. Neat! and very very very little code, I'm amazed.

# Angular - Tour of heroes pt4

Services and dependency injection.
Synchronous vs Asynchronous data delivery from a service and observables.

Right now, it feels messy that even though the components are neatly organized in named subfolders under /src/app, the services are all directly in /src/app, but they might get to that later in the tutorial.

Injecting singletons of services into other ones feels very much like Spring in Java to me.

# Day 36 Plan

* Continue with https://angular.io/tutorial/toh-pt5 on Routing
