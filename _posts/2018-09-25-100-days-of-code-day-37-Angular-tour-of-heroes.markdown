---
layout: post
title:  "100 Days of Code Day 37 - Angular tour of heroes pt6 pull request"
date:   2018-09-25 06:55:00
categories: 100DaysOfCode
---

# Angular - Tour of heroes pt6 on HTTP

Worked on the tutorial until I saw what I think is a typo in the tutorial. Tried to figure out how to assist with fixing this error and discovered that this entire tutorial is also written as an Angular app.

Made [a pull request to the angular project](https://github.com/angular/angular/pull/26094) to fix this.


# Day 38 Plan

* Continue with https://angular.io/tutorial/toh-pt6 on HTTP
