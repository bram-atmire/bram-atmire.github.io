...
I made two new landing pages for Atmire.com:
* [DSpace Hosting](https://www.atmire.com/services/dspace-hosting)
* [DSpace Customization](https://www.atmire.com/services/dspace-customization)

Also played around with the Google Adwords interface to learn more about relevant keywords for our site.

# Day 20 Plan

Back to CSS, fix the suggestions that my colleagues have raised.
