---
layout: post
title:  "100 Days of Code Day 33 - Angular baby steps"
...
I started off with the [Angular.io Quickstart Tutorial](https://angular.io/guide/quickstart).
This is basically a hello world example. I proceeded with the more extensive Tour of Heroes tutorial, where I completed pt0.

I'll be pushing the code for this tutorial to a [public repo on Github](https://github.com/bram-atmire/angular-tour-of-heroes).

# Day 34 Plan

* Continue with https://angular.io/tutorial/toh-pt1
